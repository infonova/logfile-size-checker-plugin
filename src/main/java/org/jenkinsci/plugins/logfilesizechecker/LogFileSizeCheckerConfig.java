...
@Extension
public class LogFileSizeCheckerConfig implements Describable<LogFileSizeCheckerConfig> {
    ...
    @Extension
    public static final class DescriptorImpl extends Descriptor<LogFileSizeCheckerConfig> {
        ...
        private static final Result DEFAULT_BUILD_RESULT = Result.ABORTED;
